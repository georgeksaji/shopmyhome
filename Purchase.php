      ...
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="registration-form">
          ...
          <label for="Name">Appliance name</label>
            <input type="text" id="firstName" name="name" placeholder="Name" maxlength="35" required>
          ...
          <label for="Image">Image 2</label>
            ...
            <input type="text" name="description" maxlength="50" placeholder="Description of Appliance"required>
