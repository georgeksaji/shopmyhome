      ...
      <form action="" method="POST">
        <div class="registration-form">
          <div class="registration-form-left">
              ...
              <input type="password" id="passwordright" name="passwordright" placeholder="Enter password" minlength="4" required title="Minimum 4 characters required.">
          ...
          <div class="registration-form-right">
            ...
            <input type="password" id="passwordleft" name="passwordleft" placeholder="Confirm password" minlength="4" required title="Minimum 4 characters required.">
