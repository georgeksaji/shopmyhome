...
if(isset($_POST['submit']))
{
  ...
  $passwordleft = $_POST['passwordleft'];
    ...
    //Vendor_Name 	Vendor_Phno 	Vendor_Hname 	Vendor_Street 	Vendor_Dist 	State_Ut 	Vendor_Pin 
    //update table  vednor
    $update1 = "UPDATE tbl_vendor SET Vendor_Name='$name',Vendor_Phno='$phoneNumber',Vendor_Hname='$buildingName',Vendor_Street='$street',Vendor_Dist='$district',State_Ut='$state',Vendor_Pin='$pincode' WHERE Vendor_ID='$updateid'";
...
alert(jsMessage2);
  ...
  <div class="outercontainer">
    <div class="registration-box">
      ...
      <div class="registration-box-heading">Update Vendors</div>
      <form action="" method="POST">
        <div class="registration-form">
          <div class="registration-form-left">
              <label for="Name">Vendor Partner name</label>
              <?php
    //updateid
    $sql = "SELECT * FROM tbl_vendor WHERE Vendor_ID = '$updateid'";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    //Vendor_Name 	Vendor_Phno 	Vendor_Hname 	Vendor_Street 	Vendor_Dist 	State_Ut 	Vendor_Pin 
    $name = $row['Vendor_Name'];
    $phoneNumber = $row['Vendor_Phno'];
    $buildingName = $row['Vendor_Hname'];
    $pincode = $row['Vendor_Pin'];
    $state = $row['State_Ut'];
    $street = $row['Vendor_Street'];
    $district = $row['Vendor_Dist'];
    ?>
